...
public abstract class BaseCategoryResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/batchcategory/v1.0/categories/batch' -d $'{"batchId": ___, "categories": ___, "timestamp": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Category")}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/categories/batch")
	@javax.ws.rs.POST
	@Override
	public Response postBatchCategories(
