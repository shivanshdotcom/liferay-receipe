package com.example.batchimport.resource.v1_0.test;

import com.example.batchimport.client.dto.v1_0.Category;
import com.example.batchimport.client.http.HttpInvoker;
import com.example.batchimport.client.pagination.Page;
import com.example.batchimport.client.resource.v1_0.CategoryResource;
...
public abstract class BaseCategoryResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		category.setDescription(regex);
		category.setExternalReferenceCode(regex);
		category.setName(regex);
		category.setParentExternalReferenceCode(regex);
		...
		Assert.assertEquals(regex, category.getDescription());
		Assert.assertEquals(regex, category.getExternalReferenceCode());
		Assert.assertEquals(regex, category.getName());
		Assert.assertEquals(regex, category.getParentExternalReferenceCode());
		Assert.assertEquals(
			regex, category.getVocabularyExternalReferenceCode());
	}

	@Test
	public void testPostBatchCategories() throws Exception {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.example.batchimport.dto.v1_0.Category.class)) {
	...
	protected boolean equals(Category category1, Category category2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						category1.getParentExternalReferenceCode(),
						category2.getParentExternalReferenceCode())) {
	...
	@Inject
	private com.example.batchimport.resource.v1_0.CategoryResource
		_categoryResource;
